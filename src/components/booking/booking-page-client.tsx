          ...
          <div className="grid lg:grid-cols-2 gap-6 sm:gap-10 items-center">
            <div className="hidden sm:block relative">
              <div className="relative w-full aspect-[4/4] max-w-md mx-auto lg:mx-0 rounded-2xl overflow-hidden shadow-2xl">
                <Image src="/assets/image2.jpg" alt="Sonali Bhattacharya" fill className="object-cover object-top" sizes="(max-width: 768px) 100vw, 50vw" placeholder="blur" blurDataURL={BLUR} />
            ...
            <div className="space-y-3 sm:space-y-5 text-white">
              ...
              <h2 className="text-2xl sm:text-4xl font-serif font-bold leading-tight">Sonali Bhattacharya</h2>
              <p className="text-emerald-200 font-medium text-sm">Holistic Healer & Life Coach</p>
              ...
              <div className="grid grid-cols-2 gap-2">
                {["Tarot Card Reader", "Numerologist", "Angel Healer", "Occult Consultant"].map((tag) => (
        ...
        <div className="container max-w-3xl px-4 sm:px-6">
          <div className="bg-gradient-to-br from-emerald-50 to-teal-50 rounded-2xl sm:rounded-3xl p-6 sm:p-12 border border-emerald-100 text-center space-y-4 sm:space-y-6">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
              <a href="https://wa.me/917871289207" target="_blank" rel="noopener noreferrer" className="w-full sm:w-auto inline-flex items-center justify-center gap-2 bg-emerald-600 hover:bg-emerald-700 text-white px-6 py-3 rounded-xl font-semibold text-sm transition-all duration-300 hover:shadow-lg">
                <MessageCircle className="h-4 w-4" />WhatsApp Us
              </a>
              <a href="mailto:adhyatmiksutraaonline@gmail.com" className="w-full sm:w-auto inline-flex items-center justify-center gap-2 border-2 border-emerald-600 text-emerald-700 hover:bg-emerald-600 hover:text-white px-6 py-3 rounded-xl font-semibold text-sm transition-all duration-300">
          ...
          <div className="mt-8 bg-white border border-gray-100 rounded-2xl p-6 shadow-sm">
            ...
            <div className="flex justify-center">
              <ShareButtons url={`${process.env.NEXT_PUBLIC_SITE_URL || process.env.NEXT_PUBLIC_APP_URL || 'https://adhyatmiksutraa.com'}/booking`} />
            </div>
          </div>
        </div>
      </section>
