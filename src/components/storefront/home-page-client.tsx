  ...
  const baseSlides = [
    {
      ...
      badgeIcon: "crown",
      title: "EVERY MOMENT",
      titleHindi: "\"आध्यात्मिक सूत्र\"",
      subtitle: "Do you need healing?",
      description: "At Adhyatmik Sutraa, I am your personal healing assistant, integrating ancient healing rituals into your modern lifestyle seamlessly.",
    ...
    },
    {
      ...
      titleHindi: null,
      subtitle: "Holistic Healer & Life Coach",
      description: "A professional tarot reader, numerologist, and angel healer with over 10 years of experience helping individuals step into aligned and purpose-driven living.",
      quote: "\"10+ years of experience in occult and energy-based healing\"",
    ...
    },
    {
      ...
      titleHindi: "Awakened Worldwide",
      subtitle: "Reform & Revolutionise Wellness",
      description: "Join a growing community of seekers on a mission to make holistic wellness affordable, structured, and deeply human.",
      quote: "\"10,000+ seekers guided towards spiritual awakening\"",
        ...
        <div className="grid lg:grid-cols-2 gap-6 items-center max-w-6xl mx-auto">
          ...
          <div className="space-y-3 animate-slide-up">
            ...
            <div className="space-y-3 text-slate-700 leading-relaxed text-sm sm:text-base">
              ...
              <p>
                With over a decade of experience, she offers more than 50 courses in occult sciences, tarot reading, and angel healing, guiding seekers worldwide toward authentic lives.
              </p>
            </div>
              ...
              >
                ...
                <div className="flex flex-col flex-1 p-5">
                  ...
                  <div className="flex items-center justify-between mt-4 pt-3 border-t border-gray-100 text-xs text-stone-400">
                    <span>{blog.author || "Adhyatmik Sutraa"}</span>
