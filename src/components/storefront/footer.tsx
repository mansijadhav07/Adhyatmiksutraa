          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            ...
            <div className="col-span-2 md:col-span-1 flex flex-col items-center">
              ...
              <div className="flex items-center justify-center gap-2">
                <a href="https://www.instagram.com/adhyatmiksutraa/" target="_blank" rel="noopener noreferrer" className="h-8 w-8 rounded-full bg-[#232d5f]/10 hover:bg-[#232d5f] text-[#232d5f] hover:text-white flex items-center justify-center transition-all duration-300">
                  <Instagram className="h-3.5 w-3.5" />
                </a>
                <a href="https://www.facebook.com/adhyatmiksutra" target="_blank" rel="noopener noreferrer" className="h-8 w-8 rounded-full bg-[#232d5f]/10 hover:bg-[#232d5f] text-[#232d5f] hover:text-white flex items-center justify-center transition-all duration-300">
                  <Facebook className="h-3.5 w-3.5" />
                </a>
                <a href="https://www.youtube.com/@adhyatmiksutraabysonali" target="_blank" rel="noopener noreferrer" className="h-8 w-8 rounded-full bg-[#232d5f]/10 hover:bg-[#232d5f] text-[#232d5f] hover:text-white flex items-center justify-center transition-all duration-300">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li className="flex items-center gap-2">
                  ...
                  <span className="text-xs text-[#232d5f]/90">adhyatmiksutraaonline@gmail.com</span>
                </li>
                <li className="flex flex-col gap-1 justify-start">
                  <div className="flex items-center gap-2">
                    <Phone className="h-3.5 w-3.5 text-[#d97745] flex-shrink-0" />
                    <span className="text-xs text-[#232d5f]/90">+91 78712 89207</span>
                  </div>
                  <div className="flex items-center gap-2 pl-5.5" style={{ paddingLeft: "22px" }}>
                    <span className="text-xs text-[#232d5f]/90">+91 86089 20776</span>
                  </div>
                </li>
                <li className="flex items-center gap-2">
                  <MapPin className="h-3.5 w-3.5 text-[#d97745] flex-shrink-0" />
                  <span className="text-xs text-[#232d5f]/90">India</span>
                </li>
              </ul>
            </div>
          </div>
